          ...
          <div className="row mt-3">
            <div className="col-lg-4 col-md-12 mb-4">
              ...
              <p className="grey-text blog_desc">
                by <a className="font-weight-bold">Zia Ullah</a>, 15/07/2020
              </p>
            ...
            <div className="col-lg-4 col-md-6 mb-4">
              ...
              <p className="grey-text blog_desc">
                by <a className="font-weight-bold blog_desc">Zia ullah</a>, 13/07/2018
              </p>
            ...
            <div className="col-lg-4 col-md-6 mb-4">
              ...
              <p className="grey-text blog_desc">
                by <a className="font-weight-bold">Zia Ullah</a>, 11/07/2018
              </p>
